...
<div id="jjes-main-area">
    <div class="es-admin-title"><?php echo __('Add Sale Item Name','zem_emailsystem');?></div>
    <div class="jjes-content-area">
        <form id="jjes-saveform" method="post" action="<?php echo admin_url("admin.php?page=saleitemnames&task=save"); ?>">
